...
public int CrearAdministrador (AdministradorEN administrador)
{
        try
        {
                SessionInitializeTransaction ();
...
public void ModificarAdministrador (AdministradorEN administrador)
{
        try
        {
                ...
                administradorEN.Puntuacion = administrador.Puntuacion;


                administradorEN.FechaRegistro = administrador.FechaRegistro;
